...
/* 	var metcheck = "${method}" ;
	...
	if(toDisp == 'View') {
		...
		actionLink = "modifyClientInfoConfirm.action";
		...
		<div> 
			<ul class="breadcrumb">
			 <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
			  <li> <a href="clientinfo.action?pid=141">Client Infomration</a> <span class="divider"> &gt;&gt; </span></li>
...
<input type="hidden" name="groupId"  id="groupId" value="${responseJSON.CLIENT_ID}" /> 
