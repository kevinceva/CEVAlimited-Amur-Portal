...
<body>
		    ...
		    <div> 
				<ul class="breadcrumb">
				  ...
				  <li> <a href="clientinfo.action?pid=141">Client Management</a> <span class="divider"> &gt;&gt; </span></li>
					  <li><a href="#">Modify Client Acknowledge</a></li>
				</ul>
			</div>  
	...
	<div class="row-fluid sortable"> 
		<div class="box span12">
			...
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Client Details Acknowledge
				<div class="box-icon">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
						...
						<tr class="odd">
							...
							<%-- <td width="25%" >${status}  <input type="hidden" name="status"  id="status" value="${status}" /> </td> --%>
						</tr> 
						<tr > 
							<td colspan="4"> <strong>Client Details Updated Successfully</strong> </td> 
						</tr>
				</table>
			</fieldset>  
		</div>
	...
	<div id="ben-grid"  class="row-fluid sortable"> 
		<div class="box span12">
			...
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Beneficiary Details Acknowledge
				<div class="box-icon">
					<a href="#" class="btn btn-setting btn-round"><i class="icon-cog"></i></a>
					<a href="#" class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i></a>
...
<%-- 						<tr class="odd">
						...
						<tr > 
							<td colspan="4"> <strong>Beneficiary Details Updated Successfully</strong> </td> 
						</tr>
				</table>
			</fieldset>  
		</div>
