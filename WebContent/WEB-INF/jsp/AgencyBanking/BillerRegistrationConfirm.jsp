...
$(document).ready(function(){ 
	...
	$('#btn-submit').live('click',function() {  
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/billerRegistrationAck.action";
		$("#form1").submit();					
	}); 
					...
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr>
					  	...
					  	<tr> 
							...
							<td >  <s:property value='billerBean.name' /> <input type="hidden" name="name"  id="name"   value="<s:property value='billerBean.name' />"  width="400px"  />   </td>
						...
						<tr > 
							...
							<td width="30%" > <s:property value='billerBean.accountNo' /> <input type="hidden" name="accountNo"  id="accountNo"  value="<s:property value='billerBean.accountNo' />"   /></td>														
						</tr>
						<tr>
							<td><label for="Biller Type"><strong>Biller Type</strong></label></td>
							<td>  
								 <s:property value='billerBean.billerType' /> <input type="hidden" name="billerType"  id="billerType"   value="<s:property value='billerBean.billerType' />"    />
							</td>
							<td ><label for="Bank Name" id="bnkName"><strong>Bank Name</strong></label></td>
							<td>  
								 <s:property value='billerBean.bankName' /> <input type="hidden" name="bankName"  id="bankName"   value="<s:property value='billerBean.bankName' />"    />
							</td>							
