...
$(document).ready(function(){
	...
	$('#btn-submit').on('click',function() { 
		if($("#manufacturer_form").valid()) {		
			$("#manufacturer_form")[0].action="<%=request.getContextPath()%>/<%=appName %>/manufacturerCreateConfirm.action";
		    	...
		    	<form method="post" id="manufacturer_form" class="amur-forms" name="manufacturer_form">
			       		<div class="col-sm-4 col-xs-6">
							<div class="form-group">
						       	...
						       	<input type="text" class="form-control" required=true name="manfName"  id="manfName" value="${responseJSON.subcatname}"  />
						    </div>							
					    </div>					                
					    <div class="col-sm-4 col-xs-6">
					        <div class="form-group">
					           	<label class="col-form-label" for="manfCont">Manufacturer Contact</label>
					           	<input type="text" class="form-control" required=true name="manfCont"  id="manfCont" value="${responseJSON.subcatdesc}"  />					      	
							</div>					       	
					   	</div>
					   	<div class="col-sm-4 col-xs-6">
					        <div class="form-group">
					           	<label class="col-form-label" for="manfSecCon">Manufacturer Second Contact</label>
					           	<input type="text" class="form-control" required=true name="manfSecCon"  id="manfSecCon" value="${responseJSON.subcatdesc}"  />					      	
							</div>					       	
					   	</div>
