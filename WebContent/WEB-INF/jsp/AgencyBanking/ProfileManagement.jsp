...
jQuery(document).ready(function() {
 table = $('#personTable').dataTable({
    ...
    "bProcessing" : true,
    "bServerSide" : true,
    "sAjaxSource" : path+"/com/ceva/pagination/PwalletProfileDashBoardServlet.java",
...
<form name="form1" id="form1" method="post">
		...
		<div id="content" class="span10">  
			<div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">P-Wallet Customer Profile DashBoard</a></li>
				</ul>
			</div>
		...
		<table >
			...
			<div class="box span12" id="groupInfo">
				<div class="box-header well" data-original-title>P-Wallet Customer Profile DashBoard
					<div class=
					"box-icon"> 
