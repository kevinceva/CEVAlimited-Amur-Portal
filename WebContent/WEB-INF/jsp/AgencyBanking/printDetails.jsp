...
<link href="<%=ctxstr%>/css/bootstrap-responsive.min.css" rel="stylesheet"/>   
<link rel="stylesheet" type="text/css" media="screen" href="<%=ctxstr%>/css/jquery-ui-1.8.21.custom.min.css" /> 
 
<link href="<%=ctxstr%>/css/agency-app.min.css" rel="stylesheet"/>
