		    ...
		    <div> 
				<ul class="breadcrumb">
				  <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
				   <li><a href="agentupload.action">Champion Mapping File Upload </a>  </li>
				</ul>
			</div>  
	...
	<div class="row-fluid sortable"> 
		<div class="box span12">  
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>Champion Mapping File Upload
			...
			<div class="box-content">
				<fieldset> 
						...
						<tr>
							<td width="15%" class="odd"><label for="Card Inventory File">Champion Mapping
							...
							<td class="odd" align="left" width="30%" ><input
								...
								id="cardsFile" value="Upload Champion Mapping Excel File"
								onClick="fileUpload(this.form,'<%=request.getContextPath()%>/<%=appName %>'+'/agentuploadfile.action','testid')" />
