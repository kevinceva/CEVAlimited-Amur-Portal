...
$(document).ready(function(){   
	...
	/* $("#abbreviation")
	  ...
	  //var mydata ='${billerBean.billerType}';
			//alert("biller type " + mydata)
					...
					class="table table-striped table-bordered bootstrap-datatable " > 
						<tr>
					  	...
					  	<tr> 
							...
							<td ><input type="text" name="name"  id="name" required=true  value="<s:property value='billerBean.name' />"  width="400px"  />   </td>						 
						...
						<tr > 
							...
							<td>  
								<s:select cssClass="chosen-select" 
									...
									<td width="20%"><label for="AccountNo"><strong>Account No</strong></label></td>
						...
						<tr>
							...
							<td>  
								<s:select cssClass="chosen-select" 
									...
									name="billerType" 
									value="billerBean.billerType" 
									id="billerType" 
									requiredLabel="true" 
									theme="simple"
									data-placeholder="Choose Biller Type..." 
 									 />  &nbsp; <label id="billertype-id" class="errors" ></label>
								<td width="20%"><label for="Bank Name" id="bnkName"><strong>Bank Name</font></strong></label></td>
								<td width="30%"><input type="text" name="bankName"
									id="bankName" 
									value="<s:property value='billerBean.bankName' />" ${billerBean.billerType}/>
								 </td>									 									 						
						</tr>
				</table>
			</fieldset>  
