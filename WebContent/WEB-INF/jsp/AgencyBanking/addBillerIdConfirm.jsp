...
<body>
	...
	<div class="row-fluid sortable"> 
				...
				<fieldset> 
					<table width="98%"  border="0" cellpadding="5" cellspacing="1" 
						class="table table-striped table-bordered bootstrap-datatable " > 
						 <tr> 
							<td width="20%"><label for="Biller Type Name"><strong>Biller Id</strong></label></td>
							<td width="30%" colspan=3><s:property value='payBillBean.billerId' /><input type="hidden" name="billerId"  id="billerId"   value="<s:property value='payBillBean.billerId' />"   />   </td>		 
						</tr> 
						<tr > 
							<td><label for="Description"><strong>Biller Type Name</strong></label></td>
						...
						<tr > 
							...
							<td><textarea name="description"  id="description"   style="height: 69px; width: 453px;" readonly><s:property value='payBillBean.description' /></textarea> </td> 
   	...
   	<div class="form-actions" >
         <input type="button" class="btn btn-success" type="hidden"  name="btn-submit" id="btn-submit" value="Confirm" width="100" ></input>&nbsp;
