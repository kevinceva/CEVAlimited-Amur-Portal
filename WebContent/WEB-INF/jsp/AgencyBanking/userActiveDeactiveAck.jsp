		...
		<div> 
			<ul class="breadcrumb">
			  ...
			  <li> <a href="#">User Management</a> <span class="divider"> &gt;&gt; </span></li>
				  <li><a href="#">User ${type} Acknowledge</a></li>
			</ul>
		</div>  
	...
	<div class="row-fluid sortable"> 
		<div class="box span12"> 
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>User ActiveDeactive Acknowledge
				<div class="box-icon">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr > 
							...
							<td width="30%" >${responseJSON.CV0001}<input type="hidden" name="CV0001"  id="userId" value="${responseJSON.CV0001}" /> </td>  
