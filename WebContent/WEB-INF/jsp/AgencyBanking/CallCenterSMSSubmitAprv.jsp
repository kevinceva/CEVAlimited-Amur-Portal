...
$(document).ready(function(){
	...
	{		
		...
		$('#btn-submit').live('click',function() {
			var stat = '${status}';
			console.log("stat 343434:"+stat);
			var rno = '${refno}';
			console.log("rno 343434:"+rno);
			$("#status").val(stat);
			$("#refno").val(rno);
			$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/callcentersmsdetack.action?";
			$("#form1").submit();					
		});	
	}
});
			...
			<fieldset> 
				<table width="950"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
						...
						<tr class="odd">
							<td width="25%"><strong><label for="Formatted Message">Formatted Message</label></strong></td>
 							<td width="15%" >${ftxt} <input type="hidden" name="ftxt"  id="ftxt" value="${ftxt}" /> </td>
