		    	...
		    	<form method="post" id="subcategory_form" class="amur-forms" name="subcategory_form">
			       		<div class="col-sm-4 col-xs-6">
							<div class="form-group">
						       	...
						       	<input type="text" class="form-control" required=true name="subcatname"  id="subcatname" value="${responseJSON.SUB_CATEGORY_INFO.subCategoryName}" readonly />
						    </div>
					    ...
					    <div class="col-sm-4 col-xs-6">
					        <div class="form-group">
					           	...
					           	<input type="text" class="form-control" required=true name="subcatdesc"  id="subcatdesc" value="${responseJSON.SUB_CATEGORY_INFO.subCategoryDescription}" readonly />					      	
							</div>
