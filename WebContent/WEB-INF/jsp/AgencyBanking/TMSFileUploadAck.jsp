...
$(document).ready(function() { 
	...
	$('#btn-confirm').live('click',function() {  
		$("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/tmsAct.action';
		$("#form1").submit();
		return true;
	});
			...
			<div>
				<ul class="breadcrumb">
					<li><a href="home.action">Home</a> <span class="divider">
							&gt;&gt; </span></li>
					<li><a href="tmsAct.action">TMS</a><span
						class="divider"> &gt;&gt; </span></li>
					<li><a href="#">TMS File Upload</a></li>
				</ul>
			</div>
		 ...
		 <div class="row-fluid sortable"><!--/span--> 
					<div class="box span12"> 
						<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>TMS File Upload
							<div class="box-icon">
						...
						<div id="Biller" class="box-content">
							<fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="even">
										<td ><strong>TMS File Uploaded Successfully.</strong></td>
									</tr>
 								</table> 
							 </fieldset>  
						</div> 
