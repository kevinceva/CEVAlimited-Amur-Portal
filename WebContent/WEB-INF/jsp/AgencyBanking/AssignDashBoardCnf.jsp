							...
							<table width="950" border="0" cellpadding="5" cellspacing="1"
								...
								<tr class="even">
									<td width="20%"><label for="Group Id"><strong>Group
												Id</strong></label></td>
									<td width="30%">${groupId} <input name="groupId"
										type="hidden" id="groupId" class="field" value="${groupId}" />
										<input name="userId" type="hidden" id="userId" class="field"
										value="${userId}">

									</td>
									<td width="20%"><label for="Store ID"><strong>Group
												Name</strong></label></td>
									<td width="30%">${grpname} <input name="grpname"
										type="hidden" id="groupId" class="field" value="${grpname}" />
									</td>
								</tr>
							</table>
						</fieldset>
