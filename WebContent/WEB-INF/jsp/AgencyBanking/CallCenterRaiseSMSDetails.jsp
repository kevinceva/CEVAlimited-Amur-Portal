...
jQuery(document).ready(function() {
    ...
    "bProcessing" : true,
    "bServerSide" : true,
    "sAjaxSource" : path+"/com/ceva/pagination/SMSTransactionsServlet.java?searchVal="+$("#searchVal").val()
...
$(document).on('click','a',function(event) {
	...
	var srfrom = arr[1];
	var srdate = arr[2]; 
	var queryString = 'rfrom='+srfrom+'&rdate='+srdate+'&acn='+acn; 
	console.log("valueof vid:"+v_id+"-"+queryString);
	//alert("valueof vid:"+v_id+"-"+queryString);
	if (acn != undefined  )
	{	
		postData("callcenterraisesmsdetails.action",queryString);
	}	
