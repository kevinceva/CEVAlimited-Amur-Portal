							...
							<fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="even"> 
										...
										<td width="20%"><input name="customerAccount" id="customerAccount" class="field" type="text" required=true   maxlength="20" value="<s:property value='#respData.customerAccount' />"/> &nbsp;
										</td>
