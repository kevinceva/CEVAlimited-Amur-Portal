...
<body>
	...
	<div id="content" class="span10"> 
		...
		<div class="box-content">
			<fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
						 ...
						 <tr>
							<td></td>
							<td >'${groupID}' Group Creation Successfully Done. </td>
							<td ></td>	
						</tr>
				</table>  
			</fieldset> 
		...
		<div class="form-actions">
			<input type="button" class="btn btn-primary" id="btn-submit" value="Next" />
			<input type="button" class="btn btn-info" id="btn-home" value="Home" />
