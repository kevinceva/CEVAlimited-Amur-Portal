									...
									<s:iterator value="responseJSON['AUTH_PENDING_LIST']" var="authPendingList" status="authPendingStatus">  
										<s:if test="#authPendingStatus.even == true" > 
										 ...
										 <s:elseif test="#authPendingStatus.odd == true">
											...
											<td><a href='#' class='label label-success' index="<s:property value='#authPendingStatus.index' />" data-rel='tooltip' title="Today's List is : <s:property value="#authPendingList['NEW']" />"  action="<s:property value="#authPendingList['ACTION_URL']" />"  param="AUTH_CODE=<s:property value="#authPendingList['AUTH_CODE']" />&STATUS=P"><s:property value="#authPendingList['NEW']" /></a></td>
										  	<td><a href='#' class='label label-success' index="<s:property value='#authPendingStatus.index' />" data-rel='tooltip' title="Authorized List is : <s:property value="#authPendingList['CLOSED']" />"  action="<s:property value="#authPendingList['ACTION_URL']" />"  param="AUTH_CODE=<s:property value="#authPendingList['AUTH_CODE']" />&STATUS=C"><s:property value="#authPendingList['CLOSED']" /></a></td>
										  	<td><a href='#' class='label label-important' index="<s:property value='#authPendingStatus.index' />" data-rel='tooltip' title="Rejected List is : <s:property value="#authPendingList['REJECTED']" />" action="<s:property value="#authPendingList['ACTION_URL']" />"  param="AUTH_CODE=<s:property value="#authPendingList['AUTH_CODE']" />&STATUS=R"><s:property value="#authPendingList['REJECTED']" /></a></td>
										  	<td><a href='#' class='label label-success' index="<s:property value='#authPendingStatus.index' />" data-rel='tooltip' title="Pending List is : <s:property value="#authPendingList['PENDING']" />" action="<s:property value="#authPendingList['ACTION_URL']" />"  param="AUTH_CODE=<s:property value="#authPendingList['AUTH_CODE']" />&STATUS=P"><s:property value="#authPendingList['PENDING']" /></a></td>											  
		 								</tr> 
									 </s:iterator>
								</tbody>
							</table>
