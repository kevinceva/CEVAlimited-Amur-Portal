...
// bind change event
	$('#Frequency').change(function() {
	   ...
	   // var selid = $('#Frequency option:selected').text();
		...
		$.each(arrayData1, function(selectKey, arrvalue ){ 
			var json = $.parseJSON(arrvalue); 
			var options = ''; 
		...
		$('#submitDat').live('click',function() {
			...
			$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/insertreportscheduled.action";
			$("#form1").submit();	
...
<body> 
<form method="post" id="form1" name="form1" class="form-horizontal"  autocomplete=off action='insertreportscheduled.action'>
			...
			<div class="box span12"> 
				...
				<fieldset>
							<div class="control-group">
								...
								<div class="controls">
									<select name="reportname" id="reportname" multiple  width="520px">  
								  </select>
								</div>
						</div>
  
						<div class="control-group">
								<label class="control-label" for="focusedInput"><strong>Frequency <font color=red>*</font></label>
								<div class="controls">
				  ...
				  <div class="form-actions">
					<input type="submit" class="btn btn-primary" value="Schedule Reports" />
