...
<body>
	...
	<!-- topbar ends --> 
				...
				<div class="row-fluid sortable"><!--/span-->
					...
					<div class="box span12">  
							<div class="box-header well" data-original-title>
									<i class="icon-edit"></i>Bin Activate/De-Acivate Acknowledgement
								<div class="box-icon">
						...
						<div class="box-content" id="primaryDetails"> 
						 <fieldset>  
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									...
									<tr class="even">
										<td width="20%"><strong><label for="Merchant Name">Bin Status Changed Successfully.</label></strong></td>
									</tr>
		...
		<div class="form-actions">
			 <a  class="btn btn-danger" href="#" onClick="clickBack()">Next</a> &nbsp;&nbsp;
		</div>
	</div> 
</form>
</body>
