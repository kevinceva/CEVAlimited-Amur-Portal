...
$(function () {
    ...
    $('#Submit').live('click', function () {
    		...
    		if($("#form1").valid()){
	    	    ...
	    	    $("#form1")[0].action='<%=request.getContextPath()%>/<%=appName %>/profileCashDepositSecurity.action';
				$("#form1").submit();
			return true;
    	}else{
	...
	<div id="content" class="span10">  
		<div>
			<ul class="breadcrumb">
				...
				<li><a href="#">Profile Account Credit</a></li>
			  ...
			  <div class="row-fluid sortable">
				...
				<div class="box span12">
					...
					<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Profile Account Credit Details
						<div class="box-icon">
