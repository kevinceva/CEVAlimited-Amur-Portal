	...
	<div class="row-fluid sortable"> 
		<div class="box span12">  
			<div class="box-header well" data-original-title>
				 <i class="icon-edit"></i>User ActiveDeactive 
				<div class="box-icon">
				...
				<table width="950"  border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable " >
					  <tr > 
							...
							<td width="30%" >${responseJSON.CV0001}<input type="hidden" name="CV0001"  id="userId" value="${responseJSON.CV0001}" /> <input type="hidden" name="userId"  id="userId1" value="${responseJSON.CV0001}" /> </td>  
							<td width="20%" ><strong><label for="Employee No">Employee No</label></strong></td>
							<td width="30%" >${responseJSON.CV0002}<input type="hidden" name="CV0002"  id="empNo" value="${responseJSON.CV0002}" /></td>
						</tr>
						<tr > 
