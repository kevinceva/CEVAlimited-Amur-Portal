	...
	<div id="content" class="span10">  
		<div>
			<ul class="breadcrumb">
				...
				<li><a href="#">Profile Account Credit Acknowledgement</a></li>
			</ul>
		</div>
			  ...
			  <div class="row-fluid sortable"> 
				<div class="box span12"> 
					<div class="box-header well" data-original-title>
							<i class="icon-edit"></i>Profile Account Credit Details Acknowledgement
						<div class="box-icon">
						...
						<table width="950"  border="0" cellpadding="5" cellspacing="1" 
							...
							<tr class="even">
								...
								<td width="50%" colspan="3">
									<s:property value="#respData.profileid" />    
 								</td> 
							</tr> 
							<tr class="even">
								<td><label for="Service"><strong>Profile Name</strong></label></td>
								<td colspan="3">
									<s:property value="#respData.fullName" />   
								</td> 
							</tr> 
							<tr class="even">
