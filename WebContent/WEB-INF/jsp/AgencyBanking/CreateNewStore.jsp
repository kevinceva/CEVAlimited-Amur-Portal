					...
					<div class="box-content" id="primaryDetails"> 
						<fieldset> 
							<table width="950" border="0" cellpadding="5" cellspacing="1" 
								...
								<tr class="odd">
									<td ><label for="Location"><strong>Till Id<font color="red">*</font> </strong></label></td>
									<td >
										<input name="tillId" type="text" class="field" id="tillId" value="<s:property value='#respData.tillId' />" />
									</td>
									<td ></td>
									<td ></td>	
								</tr> 		
							...
							<fieldset> 
								<table width="950" border="0" cellpadding="5" cellspacing="1" 
									 ...
									 <tr class="odd">
										...
										<td><input name="bankName" id="bankName" class="field" type="text" maxlength="50" /></td>
										<td> <label for="Description"><strong>Bank Branch<font color="red">*</font></strong></label></td>
										<td><input name="bankBranch" id="bankBranch" class="field"  type="text" /> </td>	
									 </tr>
									 <tr class="even"> 
										<td><label for="Transfer Code "><strong>Transfer Code(Swift Code)<font color="red">*</font></strong></label></td>
										<td>
											<input name="transferCode" id="transferCode" class="field"  type="text" />
										</td>
										<td></td>
										<td></td>
									</tr>
