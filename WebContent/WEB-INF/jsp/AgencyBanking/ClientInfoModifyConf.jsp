...
$(document).ready(function(){
	/* console.log("SIVAAAAAAAAAAAAAA");
	console.log(" res :"+'${responseJSON.CLIENT_ID}'); */
	$('#cid').val('${responseJSON.CLIENT_ID}');
	$('#cname').val('${responseJSON.CLIENT_NAME}');
	$('#gender').val('${responseJSON.GENDER}');
	$('#dob').val('${responseJSON.DOB}');
	$('#idty').val('${responseJSON.ID_TYPE}');
	$('#idno').val('${responseJSON.ID_NUMBER}');
	$('#mob').val('${responseJSON.MOB}');
	$('#addr').val('${responseJSON.ADDR}');
	$('#pcode').val('${responseJSON.PCODE}');
	$('#email').val('${responseJSON.EMAIL}');
	$('#cdat').val('${responseJSON.MKRDT}');
	$('#sts').val('${responseJSON.STATUS}');
	
	alert(" value of metcheck:"+"${method}");
...
/* 	var metcheck = "${method}" ;
	...
	if(toDisp == 'View') {
		actionLink = "clientinfo.action?pid=7"; 
	...
	$('#btn-cancel').live('click',function() {  
		checkLink();	
		$("#form1")[0].action="<%=request.getContextPath()%>/<%=appName %>/clientinfo.action?pid=7";
		$("#form1").submit();					
	});  
...
<body>
		...
		<div> 
			<ul class="breadcrumb">
			 <li> <a href="home.action">Home</a> <span class="divider"> &gt;&gt; </span> </li>
			  <li> <a href="userGrpCreation.action?pid=7">Client Infomration</a> <span class="divider"> &gt;&gt; </span></li>
		...
		<div class="row-fluid sortable"> 
			<div class="box span12"> 
				<div class="box-header well" data-original-title>
						<i class="icon-edit"></i> ${type} Client
					<div class="box-icon">
			...
			<fieldset> 
				<table width="950" border="0" cellpadding="5" cellspacing="1" 
					class="table table-striped table-bordered bootstrap-datatable "> 
						...
						<tr>
							<td width="25%" class="odd"><label for="ClientID">Client ID</label></td>
							<td width="25%" class="odd" align="left"><input	type="text" name="cid" id="cid" readonly /></td>

							<td width="25%" class="odd"><label for="Client Name">Clinet Name </label></td>
							<td width="25%" class="odd" align="left"><input	type="text" name="cname" id="cname" readonly />
							</td>
						</tr>	

						<tr>
							<td width="25%" class="even"><label for="ClientID">Gender</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="gender" id="gender"  /></td>

							<td width="25%" class="even"><label for="Client Name">Date Of Birth </label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="dob" id="dob"  />
							</td>
						</tr>	

						<tr>
							<td width="25%" class="even"><label for="ClientID">IDType</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="idty" id="idty" readonly /></td>

							<td width="25%" class="even"><label for="Client Name">ID Number </label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="idno" id="idno"  />
							</td>
						</tr>	
						
						<tr>
							<td width="25%" class="even"><label for="ClientID">Mobile No</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="mob" id="mob" readonly /></td>

							<td width="25%" class="even"><label for="Client Name">Address </label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="addr" id="addr"  />
							</td>
						</tr>						

						<tr>
							<td width="25%" class="even"><label for="ClientID">Postal Code</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="pcode" id="pcode" /></td>

							<td width="25%" class="even"><label for="Client Name">Email </label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="email" id="email" />
							</td>
						</tr>
						
						<tr>
							<td width="25%" class="even"><label for="ClientID">Creation date</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="cdat" id="cdat" readonly /></td>

							<td width="25%" class="even"><label for="Client Name">Status</label></td>
							<td width="25%" class="even" align="left"><input	type="text" name="sts" id="sts" readonly />
							</td>
						</tr>						
	...
	<!-- 	<div class="row-fluid sortable"> 
	   ...
	   <div class="form-actions">
			...
			<input type="button" name="btn-cancel" class="btn btn-info" id="btn-cancel" value="Back" /> 
 		 </div> 
	</div> 
