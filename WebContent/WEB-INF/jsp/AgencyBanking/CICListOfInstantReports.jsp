...
<body>
	<div class="container-fluid"
		style="width: 78%; float: left; margin-left: 3%;">
...
/* 	System.out.println(" str_reportFromDate :"+str_reportFromDate);
	System.out.println(" str_reportPath :"+str_reportPath); */
 	try
	{ 
...
/* 			System.out.println(" str contentResourceList :"+contentResourceList.length);
 */ 			String uri=contentResourceList[0].getUriString();
/*  			System.out.println(" str uri :"+uri);
 */ 			//currentUri=uri.substring(0,uri.lastIndexOf("/")-1);
 			currentUri=uri.substring(0,uri.lastIndexOf("/"));
/*  			System.out.println(" str currentUri :"+currentUri);
...
/*      			System.out.println(" str  name key:"+key);
...
<form name="form1" id="form1" method="post" action="${pageContext.request.contextPath}/<%=appName %>/cicreportsact.action">
...
<%
	...
	while(iter.hasNext())
	{
		...
		/* System.out.println("1111 key is :::: " + key);
		System.out.println("value is :::: " + value); */
		String fileNamepath=currentUri+File.separator+key;
		/* System.out.println("fileNamepath is :::: " + fileNamepath); */
		 ...
		 <script type="text/javascript">  
			$(document).ready(function () { 
				$('#save').live('click', function () {  
					$("#form1")[0].action="${pageContext.request.contextPath}/AgencyBanking/cicreportsact.action";
					$('#form1').submit(); 
				});	 
			}); 
		</script>
