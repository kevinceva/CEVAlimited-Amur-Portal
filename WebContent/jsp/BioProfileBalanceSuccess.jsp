...
<div class="row-fluid sortable">
			...
			<div class="box-content" id=" ">
			 ...
			 <table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
				<tr  class="even">
					 <td width="20%"><b>Profile Id&nbsp;&nbsp;</b> </td>
					 <td>${responseJSON.PROFILE_ID}</td>
				</tr>
				<tr  class="even">
					 <td width="20%"><b>Profile Name&nbsp;&nbsp;</b> </td>
					 <td>${responseJSON.NAME}</td>
				</tr>
				<tr  class="even">
					 <td width="20%"><b>Balance:&nbsp;&nbsp;</b> </td>
					 <td><b>${responseJSON.BALANCE} /-kshs </b></td>
				</tr>
				<tr  class="odd">
					 <td width="20%"><input class="btn btn-danger" type="submit" name="back" id="back" value="Next" /></td>
				</tr>
