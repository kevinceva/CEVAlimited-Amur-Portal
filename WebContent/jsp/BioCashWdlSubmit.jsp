	...
	$(function(){
		...
		$("#submit").click(function(){
			...
			if(amt=="" || amt=="0" || amt=="0.0"){
				...
				if(bioStatusRes == "Y"){
					$("#form1")[0].action="<%=ctxstr%>/<%=appName %>/bioWdlSubmit.action";
					$("#form1").submit();
					return true;
				}else{
...
<body >
	<form name="form1" id="form1" action="" method="get" autocomplete="off">
						 ...
						 <table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
						 	<tr >
						 		<td width="50%">
						 			<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
											<tr  class="even">
												 <td width="30%"><label for="Address Line1"><strong>Profile Id</strong></label></td>
						 		...
						 		<td>
									...
									%>
									<jsp:plugin type="applet" code="FM220Withdrawal.class" codebase="/CevaBase/jsp/test1" archive="FM220SDK.jar" width = "500" height = "400">
									<jsp:params>
