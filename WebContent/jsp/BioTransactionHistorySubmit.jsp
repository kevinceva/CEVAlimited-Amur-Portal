...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#submit").click(function(){
			if ($('#chk1').is(':checked')) {
	        	if(bioStatusRes == "Y"){
	        		$("#form1")[0].action="<%=ctxstr%>/<%=appName %>/bioprofileTransDetails.action";
					$("#form1").submit();
				}else{
						 	...
						 	<tr >
						 		<td width="50%">
						 				<table border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
											<tr  class="even">
												 <td width="35%"><label for="Address Line1"><strong>Profile Id</strong></label></td>
											...
											<tr  class="even">
												 ...
												 <td colspan="3">${responseJSON.BALANCE} /-kshs<input name="balance" type="hidden"  id="balance" class="field" maxlength='30' value="${responseJSON.BALANCE}"></td>
											</tr>
						 		...
						 		<td>
													...
													%>
													<jsp:plugin type="applet" code="FM220TxnHistory.class" codebase="/CevaBase/jsp/test1" archive="FM220SDK.jar" width = "500" height = "400">
													<jsp:params>
													...
													<input type="checkbox" name="chk1" id="chk1" value="N">
												 	<label for="Address Line1"><strong>Please select check box for proceed.</strong></label>
												 	<br/>
