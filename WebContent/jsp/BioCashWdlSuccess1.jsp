	...
	<%  
	    ...
	    if(i>0){
	    	...
	    	if(modeOfDeposit.equals("WEB")){
			    ...
			    if(j>0){
			    	message="Cash Withdrawal Transaction successfully completed with Reference number:"+ref;
			    }
		    }else if(modeOfDeposit.equals("POS")){
		    	message="Your withdrawal reference number is:"+ref+".Please complete Transaction in POS with this Reference number.";
		    }
