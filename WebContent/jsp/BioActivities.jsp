...
<body style="background: #004c89;">
	...
	<div class="page">
		...
		<div class="explorer">
		<div id="content" class="span10" style="background-color: #FFFFFF !important; position: absolute; top:30%; bottom: 30%; left: 0; right: 0; margin: auto">
			<div>
				<ul class="breadcrumb">
					<li><a href="#" style="font-size: 17px;font-variant: inherit;">Bio Activities</a></li>
				</ul>
			</div>
