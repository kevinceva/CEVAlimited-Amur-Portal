...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#submit").click(function(){
			var amt=$("#amount").val();
			var modeOfDeposit=$("#modeOfDeposit").val();
			var sendToIdNumber=$("#sendToIdNumber").val();
			
			if(amt=="" || amt=="0" || amt=="0.0"){
				alert("Please enter amount.");
				return false;
			}else if(modeOfDeposit==""){
				alert("Please select Mode of Payment.");
				return false;
			}else if(sendToIdNumber==""){
				alert("Please enter Send To ID Number.");
				return false;
			}else{
				//if(bioStatusRes == "Y"){
					$("#form1")[0].action="<%=ctxstr%>/<%=appName %>/bioSendMoneyConfirm.action";
					$("#form1").submit();
					return true;
				/* }else{
	...
	<div id="content" class="span10">  
			<div>
				 <ul class="breadcrumb">
					...
					<li><a href="#">Bio Send Money</a></li>
				</ul>
			</div>
			
			<div>
				<ul class="breadcrumb">
					<li><a href="#"  style="font-size: 15px;font-variant: inherit;">Bio Send Money</a></li>
				</ul>
			</div>
						 	...
						 	<tr >
						 		<td width="50%">
						 			...
						 			<table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
										...
										<tr  class="odd" >
											 <td width="20%"><label for="Address Line1"><strong>Send to ID Number<font color="red">*</font></strong></label></td>
											 <td colspan="3"><input name="sendToIdNumber" type="text"  id="sendToIdNumber" class="field"  value=""></td>
										</tr>
										<tr  class="odd" >
