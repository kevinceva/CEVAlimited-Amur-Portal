...
<body onload="loadData()" style="background: #004c89;">
	<form name="form1" id="form1" method="post" action="BioCashWdlSuccess.jsp" autocomplete="off">
	<div class="page">	
	<div class="header">
			 ...
			 <table width="950" border="0" cellpadding="5" cellspacing="1" class="table table-striped table-bordered bootstrap-datatable ">
				...
				<tr class="odd">
					<td colspan="2">
						...
						%>
						<jsp:plugin type="applet" code="FM220Withdrawal.class" codebase="test1" archive="FM220SDK.jar" width = "500" height = "400">
						<jsp:params>
