...
public class NewBillPaymentAction_PRD extends ActionSupport implements ServletRequestAware {

	
	
	Logger logger = Logger.getLogger(NewBillPaymentAction_PRD.class);
