...
import com.ceva.base.common.dao.CICReportDetailsDAO;
import com.ceva.base.common.dto.RequestDTO;
import com.ceva.base.common.dto.ResponseDTO;
import com.ceva.base.common.utils.CevaCommonConstants;
import com.opensymphony.xwork2.ActionSupport;

public class CICGetReportDetails extends ActionSupport {

	private static final long serialVersionUID = 1L;

	private Logger logger = Logger.getLogger(CICGetReportDetails.class);
	...
	public String allReportDetails() {
		...
		CICReportDetailsDAO configMgmtDAO = null;
		String makerId = "";
		...
		try {
			...
			configMgmtDAO = new CICReportDetailsDAO();
	...
	public String getUserAssignedReports() {
		...
		CICReportDetailsDAO reportDAO = null;
		ArrayList<String> errors = null;
		try {
			requestJSON = new JSONObject();
			requestDTO = new RequestDTO();
			...
			reportDAO = new CICReportDetailsDAO();
	...
	public String getClientPolicyNumbers() {

		logger.debug("Inside getClientPolicyNumbers...  ");
		CICReportDetailsDAO reportDAO = null;
		ArrayList<String> errors = null;
		try {
			requestJSON = new JSONObject();
			...
			requestJSON.put("USER_ID", getCid() == null ? " " : getCid());
			...
			reportDAO = new CICReportDetailsDAO();
			responseDTO = reportDAO.getClientPolicyNumbers(requestDTO);
			...
			result = "fail";
			logger.debug("Exception in getClientPolicyNumbers ["
					+ e.getMessage() + "]");
			addActionError("Internal error occured.");
		} finally {
			requestDTO = null;
