...
public class ManufacturerAction extends ActionSupport {
	...
	/*
	 * public String getMerchantDashBoard(){ return "success"; }
	 */
	...
	public String fetchManufacturers() {
		...
		try {
			...
			String webServiceURL = serverIp+"/amurcore/amur/catalog/fetchmanufacturers";
	...
	public String manufacturerInformation() {
		...
		try {
			...
			HttpPostRequestHandler httpPostRequestHandler = new HttpPostRequestHandler();
			String webServiceURL = serverIp+"/amurcore/amur/catalog/viewmanufacturer/" + manfid;
	...
	public String manufacturerModifyAck() {
		...
		try {
			...
			logger.debug("manfName[" + getManfName() + "] manfCont [" + getManfCont() + "] manfSecCon ["
					+ getManfSecCon() + "]");
			...
			HttpPostRequestHandler httpPostRequestHandler = new HttpPostRequestHandler();
			String webServiceURL = serverIp+"/amurcore/amur/catalog/modifymanufacturer/" + manfid + "/"
					+ URLEncoder.encode(manfName, "UTF-8") + "/" + manfCont + "/" + manfSecCon + "/" + mkrid;
			logger.debug("Web Service URL  :::: " + webServiceURL);
			String json1 = httpPostRequestHandler.sendRestPostRequest(webServiceURL);
			JSONObject obj = JSONObject.fromObject(json1);
			logger.debug("End to Sent Mobile Otp >> [" + obj + "] obj to string[" + obj.toString() + "]");
	...
	public String manufacturerCreateAck() {
		...
		try {
			...
			logger.debug("responseJSON[" + responseJSON + "]");
			HttpPostRequestHandler httpPostRequestHandler = new HttpPostRequestHandler();
			String webServiceURL = serverIp+"/amurcore/amur/catalog/createmanufacturer/"
					+ URLEncoder.encode(manfName, "UTF-8") + "/" + manfCont + "/" + manfSecCon + "/" + mkrid;
			logger.debug("Web Service URL  :::: " + webServiceURL);
			String json1 = httpPostRequestHandler.sendRestPostRequest(webServiceURL);
			JSONObject obj = JSONObject.fromObject(json1);
